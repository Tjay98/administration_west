...
--
-- Host: 127.0.0.1
-- Tempo de geração: 08-Dez-2020 às 23:55
...
INSERT INTO `sales_product` (`id`, `sale_group_id`, `sale_product_id`, `quantity`, `price`, `price_iva`, `created_date`) VALUES
(1, 1, 1, 1, '10.00', '2.30', '2020-12-06 23:11:12');
...
INSERT INTO `user` (`id`, `username`, `email`, `nif`, `birthday_date`, `password_hash`, `password_reset_token`, `role_id`, `company_id`, `status`, `created_at`, `updated_at`) VALUES
