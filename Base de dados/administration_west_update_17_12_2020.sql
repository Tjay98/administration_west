...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18-Dez-2020 às 00:52
...
(1, 'Produto 1', 'video-imagem-camera-fotografica.png', NULL, NULL, 1, 1, 10, '10.00', '7.70', '2.30', 1, '2020-11-15 20:07:29'),
...
(12, 'Produto 12', NULL, NULL, NULL, 1, 1, 10, '10.00', '7.70', '2.30', 1, '2020-11-15 20:07:43');
...
CREATE TABLE `sales_group` (
  ...
  `created_date` datetime NOT NULL DEFAULT current_timestamp(),
  `status` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0-por pagar 1-pago 2-enviado 3-cancelado'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `user` (`id`, `username`, `email`, `nif`, `birthday_date`, `password_hash`, `password_reset_token`, `role_id`, `store_id`, `status`, `created_at`, `updated_at`) VALUES
