...
public class Products {
    ...
    //construtor
    public Products(int id, String product_name, String image, String big_description, String category_name, int category_id, String company_name, int company_id, int quantity_in_stock, double price, double price_iva){
        this.id=id;
